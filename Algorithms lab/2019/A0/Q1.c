    ...
    void prnboth(struct Node *A,struct Node *B){
        ...
        while(key1!=NULL||key2!=NULL){
            if(key1!=NULL && key2!=NULL){
                if(key1->data==key2->data){printf("%d ",key1->data);
                key1=key1->next1;
                key2=key2->next2;}
                else if(key1->data<key2->data){printf("%d ",key1->data);
                key1=key1->next1;}
                else{printf("%d ",key2->data);
                key2=key2->next2;}
            }
            else if(key1==NULL){printf("%d ",key2->data);
                key2=key2->next2;

            }
            else if(key2==NULL){printf("%d ",key1->data);
                key1=key1->next1;
